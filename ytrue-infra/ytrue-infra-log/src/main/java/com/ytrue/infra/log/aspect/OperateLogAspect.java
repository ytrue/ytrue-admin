package com.ytrue.infra.log.aspect;
...
import com.ytrue.infra.log.util.IpUtil;
import com.ytrue.infra.log.util.OperateLogUtil;
...
public class OperateLogAspect {
     ...
     */
    @Pointcut("@annotation(com.ytrue.infra.log.annotation.OperateLog)")
